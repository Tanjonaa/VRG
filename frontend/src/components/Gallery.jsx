...
// Utilise uniquement les vraies images produits déjà disponibles
const images = [
  { src: '/images/finger-sleeve/finger-sleeve-09.webp', label: 'Finger Sleeve PUBG',       tag: 'Best-seller', span: 2 },
  { src: '/images/fan/fan-02.webp',                     label: 'Ventilateur Semi-conducteur', tag: 'Premium',    span: 1 },
  { src: '/images/finger-sleeve/finger-sleeve-08.webp', label: 'Finger Sleeve Ultra',       tag: 'Nouveau',    span: 1 },
  { src: '/images/fan/fan-01.jpg',                      label: 'Ventilateur Turbo',           tag: 'Populaire',  span: 1 },
  { src: '/images/finger-sleeve/finger-sleeve-07.webp', label: 'Finger Sleeve Slim',         tag: '',           span: 1 },
  { src: '/images/fan/fan-03.jpg',                      label: 'Ventilateur Clip-on',         tag: 'Nouveau',    span: 2 },
]
  ...
  return (
    <motion.div ref={ref}
      ...
      style={{
        ...
        gridColumn: image.span > 1 ? `span ${image.span}` : 'span 1',
        aspectRatio: image.span > 1 ? '16/9' : '1/1',
      }}>
      <motion.img src={image.src} alt={image.label}
      ...
      <motion.div initial={{ opacity: 0 }} whileHover={{ opacity: 1 }} transition={{ duration: 0.25 }}
        style={{
          ...
          background: 'linear-gradient(to top, rgba(8,8,16,0.85) 0%, rgba(8,8,16,0.2) 60%, transparent 100%)',
          display: 'flex', alignItems: 'flex-end', padding: '18px 20px',
        }}>
        <div>
          <span style={{ color: '#f0f0f5', fontSize: 15, fontWeight: 600, letterSpacing: '-0.01em', display: 'block', marginBottom: 6 }}>
            {image.label}
          </span>
          <span style={{
            display: 'inline-block', background: 'linear-gradient(135deg, #ca8a04, #d97706)',
            color: '#fff', borderRadius: 99, padding: '5px 14px', fontSize: 12, fontWeight: 700, cursor: 'pointer',
          }}>
            Commander →
          </span>
        </div>
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }}
          ...
          <p style={{ fontSize: 16, color: 'rgba(240,240,245,0.45)', marginTop: 12 }}>
            Cliquer sur un produit pour commander via WhatsApp
          </p>
        </motion.div>
