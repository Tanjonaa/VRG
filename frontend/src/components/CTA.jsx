...
const guarantees = [
  ...
  { icon: ShieldCheck,  label: 'Garantie 6 mois',    sub: 'Sur tous les produits' },
  { icon: RotateCcw,    label: 'Retour 7 jours',     sub: 'Sans question' },
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={inView ? { opacity: 1, scale: 1 } : {}}
            ...
            <div style={{ position: 'relative', zIndex: 1 }}>
              ...
              <motion.p initial={{ opacity: 0, y: 16 }} animate={inView ? { opacity: 1, y: 0 } : {}}
                ...
                Envoie-nous un message WhatsApp — on te répond en moins de 5 minutes
                et on gère ta livraison dans la journée.
              </motion.p>
              ...
              <motion.div initial={{ opacity: 0, y: 16 }} animate={inView ? { opacity: 1, y: 0 } : {}}
                ...
                <motion.button
                  whileHover={{ scale: 1.05, boxShadow: '0 0 48px rgba(34,197,94,0.4)' }}
                  whileTap={{ scale: 0.97 }}
